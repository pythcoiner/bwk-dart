...
const iosName = "bwk";
const name = "libdart_bwk";

class Dylib {
  static Map<String, dynamic>? _config;
  static String get libName => "unittest.libdart_bwk.${_config!['TAG_VERSION']}";
  ...
  static Future<void> _loadJsonAsset() async {
    final String content =
        await rootBundle.loadString("packages/bwk/assets/release.config.txt");
...
class LibBwk {
  static Future<void> init() async {
    try {
      if (!BwkCore.instance.initialized) {
        await BwkCore.init(externalLibrary: Dylib.getDylib());
      }
    } catch (e) {
      throw Exception("Failed to initialize bwk: $e");
    }
  }
}
